...
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "7년의 봄", "image/7년의 봄.jpg", 15000, "7년전 어느날 우리는 약속했었지");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "가장 바쁜사람이 가장 많은 시간을 갖는다", "image/가장 바쁜사람이 가장 많은 시간을 갖는다.jpg", 15000, "우리가 잊고 살았던 인생의 규칙 몇가지");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "고대 도시로 떠나는 여행", "image/고대 도시로 떠나는 여행.jpg", 15000, "눈이 닿지 않아도 즐거운 여행이야기");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "다양한 책표지", "image/다양한 책표지.jpg", 15000, "일러스트라면 갖고 싶은 실용적인 책표지 꾸미기");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "단편 소설 쓰기의 모든 것", "image/단편 소설 쓰기의 모든 것.jpg", 15000, "작가가 되고 싶은 사람들을 위한 국문학과 교수 책만써의 추천작");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "달의 조각", "image/달의 조각.jpg", 15000, "달 표면의 어느것, 그리고 생소했던 이야기");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "동물원이 된 미술관", "image/동물원이 된 미술관.jpg", 15000, "생동감 있는 미술관의 현장 살아 움직이는 동물들?");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "말의 품격", "image/말의 품격.jpg", 15000, "언어에서 느껴지는 기품, 의미 전달을 넘어 내면을 비추는 언어에 대하여");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "밤의 여행자들", "image/밤의 여행자들.jpg", 15000, "은밀하게 고요하게 이룩했던 역사");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "스튜디오지브리레이아웃", "image/스튜디오지브리레이아웃.jpg", 15000, "스튜디오지브리레이아웃이래 잘 모르겠다");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "아이슬란드", "image/아이슬란드.jpg", 15000, "우리에게 허용되지 않은 극한의 추위, 그 서늘함을 머금은 경험을 책속에 녹여 내었다");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "야시", "image/야시.jpg", 15000, "야시시한건 아닌것 같다");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "언제 들어도 좋은 밤", "image/언제 들어도 좋은 밤.jpg", 15000, "언제들어도 좋은 밤이라면, 한가지가 떠오르지만 언급하지 않도록 하겠다.");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "예술을 선물하세요", "image/예술을 선물하세요.jpg", 15000, "삶에 속삭입니다. 예술은 아름다운 것");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "오후를", "image/오후를.jpg", 15000, "황혼의 인생 이야기");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "우리가 집을 짓는 10가지 이유", "image/우리가 집을 짓는 10가지 이유.jpg", 15000, "집의 소중함과 뜻 깊음을 알게 해줍니다.");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "우리는 이렇게 살겠지", "image/우리는 이렇게 살겠지.jpg", 15000, "하지만, 이것은 작가의 이야기다 이제 당신의 이야기를 들려주도록");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "운동장 편지", "image/운동장 편지.jpg", 15000, "흙내음 물씬 풍기는 어느 초등학교 어린이들의...");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "이 도시에 살고 싶다", "image/이 도시에 살고 싶다.jpg", 15000, "여기는 서울인데? 집값은 준비 됐니?");
...
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "짠 하고 싶은 날에", "image/짠 하고 싶은 날에.jpg", 15000, "술한잔 사주실래요");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "책 따위 안 읽어도 좋지만", "image/책 따위 안 읽어도 좋지만책 따위 안 읽어도 좋지만.jpg", 15000, "책 따위 안 읽어도 좋지만 이책은 읽으세요");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "천문학에 관하여", "image/천문학에 관하여.jpg", 15000, "달과 지구 태양의 공전 관계");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "첫숨", "image/첫숨.jpg", 15000, "첫숨의 의미 거룩한 탄생");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "틈새보이스", "image/틈새보이스.jpg", 15000, "틈새의 틈새에 틈새를 위한");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "학교현장 중심의 교육정책 통합성 제고방안", "image/학교현장 중심의 교육정책 통합성 제고방안.jpg", 15000, "재고방안 같지만 넘어가도록 합시다. 딱딱한 이야기");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "현대 프랑스 철학사", "image/현대 프랑스 철학사.jpg", 15000, "프랑스 혁명 그 이후의 이야기");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "휴식", "image/휴식.jpg", 15000, "열심히 일한 당신 쉬어라");
...
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "just i fied", "image/just i fied.jpg", 15000, "다른 의미를 찾아보도록");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "soma night & day", "image/soma night & day.jpg", 15000, "~~흥흥~~~ 흥흥흥.. 즐거운 펍이 생각난다");
insert into product (category_idx, product_quantity, product_name, product_image, product_price, product_desc) values (1, 100, "Vacation", "image/Vacation.jpg", 15000, "방학이다!!!!!!!!!!!!!!!!!!!!!!!!!!!");
