				...
				<tr>
					<td align=center>
						...
						<table border=0>
								...
								<td colspan=2>
									<table>
										<tr>
											...
											<td width=80>전자메일 :</td>
											<td width=100><input type=text name=email size=30
							...
							<tr>
								<td colspan=2><textarea name=content rows=10 cols=90><%=content%></textarea></td>
							</tr>
							<tr>
